...
export class NotifyService {
  ...
  confirm(message: string) {
    if (!$('#confirmModal').length) {
      $('body').append(`<div id="confirmModal" class="modal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button id="yesButton" type="button" class="btn btn-default" data-dismiss="modal">Dong y</button>
          <button id="cancleButton" type="button" class="btn btn-default" data-dismiss="modal">Huy</button>
        </div>
      </div>
